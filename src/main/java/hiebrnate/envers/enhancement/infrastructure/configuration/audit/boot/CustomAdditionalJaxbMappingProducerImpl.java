...
public class CustomAdditionalJaxbMappingProducerImpl implements AdditionalJaxbMappingProducer {
    private static final Logger log = Logger.getLogger( CustomAdditionalJaxbMappingProducerImpl.class );
