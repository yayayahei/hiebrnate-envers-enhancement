...
import org.hibernate.envers.configuration.internal.*;
...
public class CustomEnversServiceImpl implements CustomEnversService, Configurable, Stoppable {
    ...
    private void doInitialize(
        ...
        CustomEnversServiceImpl.this.auditEntitiesConfiguration = new AuditEntitiesConfiguration(
            properties,
        ...
        this.entitiesConfigurations = new CustomEntitiesConfigurator().configure(
            metadata,
            serviceRegistry,
            reflectionManager,
            mappingCollector,
