...
import org.hibernate.envers.internal.entities.mapper.relation.*;
import org.hibernate.envers.internal.entities.mapper.relation.component.*;
import org.hibernate.envers.internal.entities.mapper.relation.lazy.proxy.*;
...
public class CustomCollectionMetadataGenerator {
     ...
     */
    public CustomCollectionMetadataGenerator(
        CustomAuditMetadataGenerator mainGenerator,
    ...
    private void addWithMiddleTable() {
        ...
        final CustomQueryGeneratorBuilder queryGeneratorBuilder = new CustomQueryGeneratorBuilder(
            mainGenerator.getGlobalCfg(),
            mainGenerator.getVerEntCfg(),
            mainGenerator.getAuditStrategy(),
            referencingIdData,
    ...
    private MiddleComponentData addIndex(Element middleEntityXml, CustomQueryGeneratorBuilder queryGeneratorBuilder) {
        if ( propertyValue instanceof IndexedCollection ) {
            ...
            final javax.persistence.EnumType mapKeyEnumType = propertyAuditingData.getMapKeyEnumType();
    ...
    private MiddleComponentData addValueToMiddleTable(
        Value value,
        Element xmlMapping,
        CustomQueryGeneratorBuilder queryGeneratorBuilder,
        String prefix,
    ...
    private void addMapper(
        ...
        if ( type instanceof SortedSetType ) {
            ...
            currentMapper.addComposite(
                propertyAuditingData.getPropertyData(),
                new BasicCollectionMapper<java.util.Set>(
                    commonCollectionMapperData,
                    HashSet.class,
                    SetProxy.class,
                    elementComponentData,
            ...
            currentMapper.addComposite(
                propertyAuditingData.getPropertyData(),
                new MapCollectionMapper<java.util.Map>(
                    commonCollectionMapperData,
                    HashMap.class,
                    MapProxy.class,
                    elementComponentData,
            ...
            currentMapper.addComposite(
                propertyAuditingData.getPropertyData(),
                new BasicCollectionMapper<java.util.List>(
                    commonCollectionMapperData,
                    ArrayList.class,
                    ListProxy.class,
                    elementComponentData,
