...
import org.hibernate.envers.configuration.internal.metadata.*;
...
public class CustomAuditMetadataGenerator {
     ...
     */
    private final CustomBasicMetadataGenerator basicMetadataGenerator;
    private final CustomComponentMetadataGenerator componentMetadataGenerator;
    private final CustomIdMetadataGenerator idMetadataGenerator;
    private final CustomToOneRelationMetadataGenerator toOneRelationMetadataGenerator;
    ...
    public CustomAuditMetadataGenerator(
        ...
        this.basicMetadataGenerator = new CustomBasicMetadataGenerator( this );
        this.componentMetadataGenerator = new CustomComponentMetadataGenerator( this );
        this.idMetadataGenerator = new CustomIdMetadataGenerator( this );
        this.toOneRelationMetadataGenerator = new CustomToOneRelationMetadataGenerator( this );
    ...
    private void addValueInSecondPass(
        ...
        if ( type instanceof ComponentType ) {
            ...
            final CustomCollectionMetadataGenerator collectionMetadataGenerator = new CustomCollectionMetadataGenerator(
                this,
                (Collection) value,
                currentMapper,
                entityName,
    ...
    CustomBasicMetadataGenerator getBasicMetadataGenerator() {
